        ...
        <div className="flex flex-col justify-between gap-14 md:flex-row md:gap-32">
          <div className="flex flex-col justify-around gap-4 lg:gap-0">
            ...
            <p>
              ...
              cada proyecto, asegurando{" "}
              <strong>resultados excepcionales</strong> y la{" "}
              <strong>satisfacción</strong> de nuestros clientes. Nuestro equipo
              de profesionales altamente calificados y con{" "}
              ...
              cliente es único, por lo que trabajamos estrechamente con ellos
              para diseñar y ejecutar estrategias que impulsen su{" "}
              ...
              permite ofrecer soluciones que no solo resuelven problemas
              actuales, sino que también anticipan futuras necesidades.
            </p>
          </div>
          <img
            src={scaleGraphImg}
